$(function () {
    $("#btn_t").click(function (e) {
        e.preventDefault();
        $.get("/Admin/Partners/Create", function (data) {
    ...
    $("body").on("click", "#btn_save_create", function (e) {
        e.preventDefault();
        if ($("#frmCreatePartners").valid()) {
            $("#frmCreatePartners").submit();
        }
    })
    $("body").on("click", "#btn_save_edit", function (e) {
        e.preventDefault();
        if ($("#frmEditPartners").valid()) {
            $("#frmEditPartners").submit();
        }
    })
    $("body").on("click", ".btn-edit", function (e) {
        e.preventDefault();
        var id = $(this).data("id");
        $.get("/Admin/Partners/Edit/" + id, function (data) {
            $('#sharing_modal .modal-content').html(data);
            $('#sharing_modal').modal('show');
        });
    })
    ...
    $("body").on("click", ".btn-delete", function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.get("/Admin/Partners/Delete/" + id, function (res) {
