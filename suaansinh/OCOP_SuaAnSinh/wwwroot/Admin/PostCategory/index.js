$(function () {
    $("#btn_add").click(function (e) {
        e.preventDefault();
        $.get("/Admin/PostCategories/Create", function (data) {
    ...
    $("body").on("click", "#btn_save_create", function (e) {
        e.preventDefault();
        if ($("#frmCreatePostCategory").valid()) {
            $("#frmCreatePostCategory").submit();
        }
    })
    $("body").on("click", "#btn_save_edit", function (e) {
        e.preventDefault();
        if ($("#frmEditPostCategory").valid()) {
            $("#frmEditPostCategory").submit();
        }
    })
    $("body").on("click", ".btn-edit", function (e) {
        e.preventDefault();
        var id = $(this).data("id");
        $.get("/Admin/PostCategories/Edit/" + id, function (data) {
            $('#sharing_modal .modal-content').html(data);
            $('#sharing_modal').modal('show');
        });
    })
    ...
    $("body").on("click", ".btn-delete", function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.get("/Admin/PostCategories/Delete/" + id, function (res) {
